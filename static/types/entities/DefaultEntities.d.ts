...
declare class ThingShapeEntity<T extends ThingShapeBase> extends RootEntity {
	 ...
	 * @return Implementing Things
	 */
	GetImplementingThingsWithData(args?:{}): INFOTABLE<RootEntityList & Struct<T>>;
...
declare class StyleThemeEntity extends RootEntity {
...
declare interface DataShapes {
	 ...
	 * Thing names
	 */
	ThingNames: DataShapeEntity<ThingNames>
 ...
 * Thing names
 */
declare class ThingNames extends DataShapeBase {
