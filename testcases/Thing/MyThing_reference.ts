...
class MyThing extends ThingTemplateWithShapes(RemoteThing, Tunneling) {
     ...
     */
    @localSubscription('DataChange', 'streamToUse') streamToUseChanged(
        alertName: STRING,
     ...
     */
    @subscription('AuditDataTable', 'DataChange', 'thingTemplate') auditDataTableThingTemplateChanged(
        alertName: string,
        eventData: INFOTABLE<DataChangeEvent>,
        eventName: string,
        eventTime: Date,
